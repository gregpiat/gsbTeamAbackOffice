    ...
    public partial class formCreerClient : Form
    {
        ...
        private void btnAjouterClient_Click(object sender, EventArgs e)
        {
            ...
            && txbMailClientAjout.Text != "")
            {
                ...
                try
                {
                    daoClient.ajouterClient(55, txbNomClientAjout.Text, txbPrenomClientAjout.Text, cbxRaisonClientAjout.Text, txbAdresseAjout.Text, txbCpClientAjout.Text, txbVilleClientAjout.Text, 1, txbMailClientAjout.Text, txbTelephoneClientAjout.Text);
                }
                catch (Exception ex)
                {
